...
namespace Enigma
{
    ...
    public static class EnigmaMachine
    {
        ...
        //This code for method Encode has been generated by ChatGPT on Jan 20th 2025 
        public static string Encode(string message, int incrementNumber, List<string> rotors)   
        {
            //Format the input message
            string formattedMessage = FormatInputMessage(message);
    
            //Apply CaesarShift to the formatted message
            string caesarShiftedMessage = CaesarShift(formattedMessage, incrementNumber, true);

            //Apply each rotor to the caesar shifted message
            string encodedMessage = caesarShiftedMessage;
